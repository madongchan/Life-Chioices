...
namespace Febucci.UI
{
    ...
    public class TextAnimatorPlayer : Core.TAnimPlayerBase
    {
        ...
        [SerializeField, Tooltip("True if this Textbox is Linked child")] public bool isLinkedTextbox = false;
        [SerializeField, Tooltip("Is typewritter skipped")] public bool isSkipped = false;
