...
namespace Febucci.UI {
    using Character = Febucci.UI.Core.Character;
    /// <summary>
    ...
    public class TextAnimator : MonoBehaviour {
        private bool _isLineBreaked;

        public bool isLineBreaked {
            get => _isLineBreaked;
            set => _isLineBreaked = value;
        } 
...
#pragma warning restore 0649
        ...
        public char IncreaseVisibleChars() {
            if (!hasText)//텍스트가 없는 경우
          {
            ...
            if (textInfo.characterInfo[visibleCharacters - 1].isVisible) { //might be a space or sprite
